  ...
  useGSAP(
    () => {
      ...
      sun2.to(
        ...
        { attr: { "stop-color": "#623951" } },
        0
      );
      sun2.to(
        "#lg4 stop:nth-child(2)",
        { attr: { "stop-color": "#261F36" } },
        0
      );
      sun2.to(
        "#bg_grad stop:nth-child(6)",
      ...
      sceneTransition.to(
        "#h2-1",
        { y: -height - 100, scale: 1.5, transformOrigin: "50% 50%" },
        0
      );
        ...
        <g id="scene3" style={{ visibility: "hidden" }}>
          ...
          <g id="hills3" transform="translate(0, -110)">
            ...
            <g id="h3-1">
              ...
              <g id="dinoL" style={{ fill: "#fff", opacity: ".2" }}>
              ...
              <g id="dinoR" style={{ fill: "#fff", opacity: ".2" }}>
